...
export function CommanderChat() {
  ...
  return (
    <div className="glass-panel border-white/5 flex flex-col h-[500px] rounded-2xl overflow-hidden bg-[#0A0A0B]/80 font-mono shadow-2xl">
      <div className="bg-[#161618] p-3 border-b border-white/5 flex items-center justify-between">
        ...
        <div className="flex gap-1.5">
          <div className="w-2.5 h-2.5 rounded-full bg-[#ff2a2a]/40"></div>
          <div className="w-2.5 h-2.5 rounded-full bg-[#f59e0b]/40"></div>
          <div className="w-2.5 h-2.5 rounded-full bg-[#4A6CF7]/40"></div>
        </div>
      </div>
